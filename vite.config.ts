...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: '@shadcn/components', replacement: path.resolve(__dirname, 'src', 'shadcn', 'components', 'ui') },
      { find: '@shadcn/layout', replacement: path.resolve(__dirname, 'src', 'shadcn', 'components', 'ui', 'layout') },
      { find: '@shadcn/typography', replacement: path.resolve(__dirname, 'src', 'shadcn', 'components', 'ui', 'typography') },
