...
export default function App() {
  return (
    <Box className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background-50 via-background-100 to-brand-50">
            ...
            <VStack className="gap-6">
              <Box className="flex items-start gap-4">
                ...
                <Box>
                  ...
                  <Text className="text-typography-600 mt-2">
                    Pequena demo com componentes utilitários e layout criados localmente (shadcn-like). 
                    Use este esqueleto como ponto de partida para seus protótipos em React + Vite + Tailwind.
                  </Text>
                </Box>
              </Box>
          ...
          <Box className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-in fade-in-0 zoom-in-95 duration-500 delay-500">
            ...
            <Box className="rounded-lg bg-brand-50 border border-brand-200 p-6 transition-all hover:bg-brand-100 hover:border-brand-300 hover:shadow-soft-1">
              ...
              <Text className="text-typography-600 text-sm">
                Paleta de cores completa com brand, estados (success, warning, error) e tipografia consistente.
              </Text>
            </Box>
            ...
            <Box className="rounded-lg bg-success-50 border border-success-200 p-6 transition-all hover:bg-success-100 hover:border-success-300 hover:shadow-soft-1">
              ...
              <Text className="text-typography-600 text-sm">
                Box, VStack, HStack, Container, Title, Text, Button, Link e mais componentes reutilizáveis.
              </Text>
            </Box>
